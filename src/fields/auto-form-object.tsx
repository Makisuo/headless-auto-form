...
import { DEFAULT_ZOD_HANDLERS } from "../config.js"
import { useFormContext } from "../form-provider.js"
import type { FieldConfig, FieldConfigItem, InputComponents } from "../types.js"
import { beautifyObjectName, getBaseSchema, getBaseType, zodToHtmlInputProps } from "../utils.js"
...
export function AutoFormObject<SchemaType extends z.ZodObject<any, any>>({
	...
	return (
		<div className={cn("space-y-layout-sm border-none", className)}>
			{Object.keys(shape).map((name) => {
				...
				if (zodBaseType === "ZodObject") {
					...
					// 	</AccordionItem>
					// )
					return <div>Reimplment Objects</div>
				}
					...
					<Field
						...
						children={(field) => {
							...
							const InputComponent =
								typeof inputType === "function" ? inputType : inputComponents[inputType]
